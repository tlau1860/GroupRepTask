...
jsPsych.plugins["single-stim-sam"] = (function() {
	...
	trial.prompt_regex = trial.prompt_regex || /(.*)/;
	trial.stim_regex = trial.prompt_regex || /(.*)/;
	...
	var end_trial = function() {
		...
		"name": trial.stimulus.match(trial.stim_regex)[1],
		"prompt": trial.prompt.text(),
		"classification": trial.prompt.text().match(trial.prompt_regex)[1],
